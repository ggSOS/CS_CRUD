        ...
        public static void Main(String[] args)
        {
            try
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(builder.ConnectionString))
                {
                    ...
                    SelectOperation(connection, table);

                    InsertOperation(connection, table, "Antonio", "15");
                    SelectOperation(connection, table);

                    UpdateOperation(connection, "4", table, "Serjo", "14");
                    SelectOperation(connection, table);

                    DeleteOperation(connection, "4", table);
                    SelectOperation(connection, table);
